...
## Fase 2 — Organização Comercial (Concluída em 04/05/2026)

- [x] Migração aditiva no banco: temperatura, rendaInformada, usaFgts, entradaDisponivel, dataNascimento, cpf, utmSource/Medium/Campaign/Content/Term, primeiroContatoEm, tempoAtePrimeiroContato
- [x] Campo naoCompareceu e motivoNaoCompareceu na tabela agendamentos
- [x] ENUM status de agendamentos atualizado com nao_compareceu
- [x] Filtro de temperatura na query getAllLeads (backend + router)
- [x] Badge de temperatura nos cards de lead (Quente/Morno/Frio)
- [x] Filtro de temperatura na tela de leads
- [x] Seção de Temperatura e Qualificação Financeira no dialog de detalhes do lead
- [x] Botão Não Compareceu na página de Agendamentos
